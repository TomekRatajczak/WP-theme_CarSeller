            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-4 px-5">
                    ...
                    <ul>
                        ...
                        <li><a class="link-scroll" href="#sprzedaz">Sprzedaż aut używanych</a></li>
                        ...
                        <li><a class="link-scroll" href="#kontakt">Kontakt z nami</a></li>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-4 px-5">
                    <div>
                        <a class="" href="http://www.rzetelnafirma.pl/30VF6F0Z/1" target="_blank">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/baner_03.jpg" class="img-fluid" alt="...">
                        </a>
                    </div>
                </div>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LcQ1GEaAAAAAJUravWTFjmVXSmvpyZzjnxtOdiI"></script>
